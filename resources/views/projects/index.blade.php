                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 hidden sm:table-cell">Start Date</th>
                            <th scope="col" class="px-4 py-3 hidden lg:table-cell">End Date</th>
                        ...
                        @forelse ($projects as $project)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition duration-150">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    @php
                                        $statusClasses = match(strtolower($project->status)) {
                                ...
                                <td class="px-4 py-4 text-right whitespace-nowrap space-x-2">
                                    <a href="{{ route('projects.show', $project) }}" class="font-medium text-blue-600 dark:text-blue-400 hover:underline">View</a>
                                    <a href="{{ route('projects.edit', $project) }}" class="font-medium text-amber-600 dark:text-amber-400 hover:underline">Edit</a>
