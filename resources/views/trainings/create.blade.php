            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('trainings.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Hold Ctrl (or Cmd) to select multiple employees.</p>
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <x-primary-button>{{ __('Save Training') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
